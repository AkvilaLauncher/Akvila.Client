...
using Models_IUser = Akvila.Client.Models.IUser;

namespace Akvila.Client.Helpers;
...
public class ApiProcedures {
    ...
    public async Task<(Models_IUser User, string Message, IEnumerable<string> Details)> Auth(string login, string password,
        string hwid) {
#if DEBUG
    ...
    public async Task<(Models_IUser User, string Message, IEnumerable<string> Details)> Auth(string accessToken) {
#if DEBUG
