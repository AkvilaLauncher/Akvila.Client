...
public class AkvilaClientManager : IAkvilaClientManager {
    ...
    public AkvilaClientManager(string installationDirectory, string gateWay, string projectName, OsType osType) {
    ...
    IObservable<int> IAkvilaClientManager.ProgressChanged => _progressChanged;
